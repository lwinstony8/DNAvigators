...
q_model_2 = sca.models.MultiVAE.load_query_data(query, model)
q_model_2.train(weight_decay=0, max_epochs=10)

q_model_2.get_latent_representation(adata=query)
q_model_2.get_latent_representation(adata=adata)
...
sc.pp.neighbors(adata_both, use_rep='latent')
sc.tl.umap(adata_both)
sc.pl.umap(adata_both, color=['l1_cell_type', 'l2_cell_type', 'reference', 'Modality', 'Samplename'], ncols=1, frameon=False, save='multivae_both_modality.png')
...
sc.pl.umap(
    ...
    frameon=False,
    groups=['CITE-seq query'],
    save='multivae_cite_query_celltype_modality.png'
)
...
sc.pl.umap(
    ...
    frameon=False,
    groups=['multiome query'],
    save='multivae_multiome_query_celltype_modality.png'
)
...
sc.pl.umap(
    ...
    frameon=False,
    groups=['scRNA query'],
    save='multivae_scRNA_query_celltype_modality.png'
)
...
sc.pl.umap(
    ...
    frameon=False,
    groups=['ATAC query'],
    save='multivae_atac_query_celltype_modality.png'
)